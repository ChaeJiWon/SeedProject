...
#include "..//SeedEngineSorce/seRenderer.h"
#include "..//SeedEngineSorce/seGameObject.h"
#include "..//SeedEngineSorce/seTransform.h"
...
namespace gui
{
	...
	bool EditorApplication::imGguiInitialize()
	{
		...
		se::graphics::GraphicDevice_DX11*& graphicdevice = se::graphics::GetDevice();
	...
	void EditorApplication::dockSpaceOnGui()
	{
		...
		{
			ImGuiID dockspace_id = ImGui::GetID("SeedDockingSpace");
