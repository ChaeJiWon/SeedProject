...
namespace se::graphics
{
	...
	public:
		...
		void BindViewPort(UINT width, UINT height);
	...
	// 이 함수는 전역 장치 인스턴스에 접근하기 위한 헬퍼입니다.
	// - 엔진에서 이 함수를 사용하지만, 단일 전역 장치 객체를 반드시 사용할 필요는 없습니다.
	// - 이 함수는 수명 관리 객체가 아니라, 포인터를 통해 객체에 대한 참조를 전역적으로 노출하는 방법일 뿐입니다.
