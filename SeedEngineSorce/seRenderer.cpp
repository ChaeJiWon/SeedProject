...
#pragma endregion
	...
	void LoadShaders()
	{
		Resources::Load<Shader>(L"TriangleShader", L"..\\ShadersSorce\\Triangle");
		Resources::Load<Shader>(L"SpriteDefaultShader", L"..\\ShadersSorce\\SpriteDefault");
		Resources::Load<Shader>(L"WireframeShader", L"..\\ShadersSorce\\Wireframe");
